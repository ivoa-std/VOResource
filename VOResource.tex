...
\xmlel{xsi:type}), as non-schema aware XML processors cannot
...
% TODO: subsubsection name convention?  What are the further subsections
% then?
...
determines the protocol spoken --, the speficication of \xmlel{version}
...
\item[Type] string: \xmlel{xs:token}
\item[Meaning] 
               Nature or genre of the content of the resource.  Terms here
               should taken from the RDF vocabulary at
...
\item[Meaning] 
                ...
                The terms should be taken from the controlled vocabulary at
...
% GENERATED: !schemadoc VOResource-v1.0.xsd ValidationLevel
\begingroup
      	\renewcommand*\descriptionlabel[1]{%
...
The \xmlel{rights} element contains freetext, where it is recommended
that standard licenses are named and special circumstances like embargos
are mentioned.  The \xmlel{rightsURI} attribute can be used to link to
full license text.  By re-using the license author URIs, machines can
identify ussage conditions.


% GENERATED: !schemadoc VOResource-v1.0.xsd Rights
\begingroup
      	\renewcommand*\descriptionlabel[1]{%
...
sect.~\ref{sect:servicemodel}, the \xmlel{interface} element must not be

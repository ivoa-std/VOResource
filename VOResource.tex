...
\item[Meaning] 
                  ...
                  use a form like\hfil\break bibcode:2008ivoa.spec.0222P.
...
\begin{quotation}\noindent
% GENERATED: sed -e 's/\([^;]*\);.*/\\textsl{\1},/;$s/,$//' terms/content_level.terms
\textsl{Research},
\textsl{Amateur},
\textsl{General}
...
\begin{quotation}\noindent
% GENERATED: sed -e 's/\([^;]*\);.*/\\textsl{\1},/;$s/,$//' terms/content_type.terms
\textsl{Other},
\textsl{Archive},
\textsl{Bibliography},
\textsl{Catalog},
...
\begin{quotation}\noindent
% GENERATED: sed -e 's/\([^;]*\);.*/\\textsl{\1},/;$s/,$//' terms/relationship_type.terms | sort -i
\textsl{Cites},
\textsl{Continues},
\textsl{HasPart},
\textsl{IsContinuedBy},

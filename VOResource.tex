...
% TODO: We probably don't want this any more
...
supports a version other than \texttt{"1.0"}, the \xmlel{interface}
...
attribute are not controlled; however, several values are recommended
below and may be recognized by applications. Other roles may be given.
If a role is not given, applications should interpret the date as
